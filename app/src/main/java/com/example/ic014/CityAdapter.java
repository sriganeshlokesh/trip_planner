...
public class CityAdapter extends RecyclerView.Adapter<CityAdapter.ViewHolder> {
    ...
    public CityAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LinearLayout rv_layout = (LinearLayout) LayoutInflater.from(parent.getContext()).inflate(R.layout.city_layout, parent, false);
    ...
    public void onBindViewHolder(@NonNull CityAdapter.ViewHolder holder, final int position) {
        ...
        holder.textViewDescirption.setText(cities.get(position).place_address);
